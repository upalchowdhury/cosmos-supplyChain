...
import (
	...
	"github.com/upalchowdhury/supplychain/docs"

	supplychainmodule "github.com/upalchowdhury/supplychain/x/supplychain"
	supplychainmodulekeeper "github.com/upalchowdhury/supplychain/x/supplychain/keeper"
	supplychainmoduletypes "github.com/upalchowdhury/supplychain/x/supplychain/types"
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		supplychainmodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	SupplychainKeeper supplychainmodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		supplychainmoduletypes.StoreKey,
	...
	app.SupplychainKeeper = *supplychainmodulekeeper.NewKeeper(
		...
		app.GetSubspace(supplychainmoduletypes.ModuleName),
	)
	supplychainModule := supplychainmodule.NewAppModule(appCodec, app.SupplychainKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(supplychainmoduletypes.ModuleName)
